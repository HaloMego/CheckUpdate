...
public class UpdateConstant {
    ...
    public static String SERVER_DOWNLOAD_PURE = "http://android.myapp.com/myapp/detail.htm?apkName=%s";

    public static String SERVER_DOWNLOAD_TENCENT = "http://www.wandoujia.com/apps/%s";
}
